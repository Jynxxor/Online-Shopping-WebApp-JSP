...
try{
	...
	ResultSet rs = stm.executeQuery("SELECT * FROM cart INNER JOIN product WHERE cart.product_id=product.id AND cart.email='"+email+"' AND cart.orderDate is NOT NULL;");
	while(rs.next()){
		sno += 1;
%>
          <tr>
