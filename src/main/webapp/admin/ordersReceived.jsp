...
try{
	...
	ResultSet rs = stm.executeQuery("SELECT * FROM cart INNER JOIN product WHERE cart.product_id = product.id AND cart.orderDate IS NOT NULL AND cart.status = 'processing';");
